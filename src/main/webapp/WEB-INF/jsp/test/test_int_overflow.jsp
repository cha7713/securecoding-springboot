...
<body>
 ...
 숫자입력: <input type="text" name="data"  id="data14" size="40"> <input type="button" id="button14" value="실행"   data-toggle="modal" data-target="#myModal"> 
