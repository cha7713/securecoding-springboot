				...
				<div id="box2">
					...
					<div id="labs">
						...
						<div class="hint" id="div16">
							<p id="select-test">TOCTOU<span style="font-size: 10pt; color: navy;">(검사시점과 사용시점)</span></p>
							
							<form action=" concurrency_test.do" id="form16">
								<pre> <p class="comment"> <br><br><br>1~9 까지의 숫자를 입력하세요. 동일한 연산을 수행하고 2초 간격으로 두번 측정합니다! </p> <br> <input  type="text" name="data" id="data16" size="40"> <input
										type="button" id="button16" value="실행" data-toggle="modal" data-target="#myModal">
