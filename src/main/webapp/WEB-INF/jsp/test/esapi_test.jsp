...
인코딩할 문자열: <input type="text" name="data" id="data1" size="50"> <input
										type="button" id="button1" value="실행"> 
<br />    
 ...
 암호화할 문자열: <input type="text" name="data" id="data2" size="50">  <input
										type="button" id="button2" value="실행">
 ...
 ID: <input type="text" name="id" id="data8"> PASSWORD: <input
										type="password" name="passwd" id="data8"> <input
										type="button" id="button8" value="로그인">      
          </pre>
...
문자열입력: <input type="text" name="data" id="data3" size="50"> <input
										type="button" id="button3" value="실행">
 <br /><br />     
						...
						<div class="hint" id="div5">
							...
							<form action="esapi_authenticator_test.do" id="form4">
								<pre>
[STEP 1] 회원가입    <br />
          ID: <input type="text" name="id" id="data4"> PASSWORD: <input
										type="password" name="passwd" id="data4"> <input
										type="button" id="button4" value="회원가입">
          </pre>
							</form>
							...
							<form action="esapi_login_test.do" id="form5">
								<pre>
[STEP 2] 로그인   <br />
          ID: <input type="text" name="id" id="data5"> PASSWORD: <input
										type="password" name="passwd" id="data5"> <input
										type="button" id="button5" value="로그인">     
          </pre>
							</form>
...
문자열입력: <input type="text" name="data" id="data8" size="50"> <input
										type="button" id="button6" value="실행">
          </pre>
							</form>
						</div>
