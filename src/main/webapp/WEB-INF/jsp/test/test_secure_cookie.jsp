				...
				<div id="box2">
					...
					<div id="labs">
						...
						<div class="hint" id="div9">
							...
							<br>
							<br>
							<p id="comment">중요정보를 쿠키에 담아서 전송해야 하는 경우 반드시 setscure(true)을
								적용하여 https 통신에서만 쿠키가 전달될 수 있도록 구현해야 합니다.</p>
							<form action="secure_cookie_test.do" id="form9">
								<pre>

전송데이터: <input type="text" name="data" id="data9" size="30"> <input
										type="button" id="button9" value="실행" data-toggle="modal" data-target="#myModal">
 <br />
